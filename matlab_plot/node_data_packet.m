...
% 读取相对路径下的数据文件
%% 节点4图
filepath1 = '../result/data/main_other_alg_episode_node4_msg_number.mat';
node_data = load(filepath1)

figure
plot(node_data.main_other_alg_episode_slot_time,node_data.main_other_alg_episode_msg_num)
hold on 

filepath2 = '../result/data/main_v130_1100_episode_node4_msg_number.mat'
node_data2 = load(filepath2)

plot(node_data2.main_v130_1100_episode_slot_time,node_data2.main_v130_1100_episode_msg_num)

hold off


%% 节点5图
filepath1 = '../result/data/main_other_alg_episode_node5_msg_number.mat';
node_data = load(filepath1)
...
filepath2 = '../result/data/main_v130_1100_episode_node5_msg_number.mat'
node_data2 = load(filepath2)
...
%% 节点7图
filepath1 = '../result/data/main_other_alg_episode_node7_msg_number.mat';
node_data = load(filepath1)
...
filepath2 = '../result/data/main_v130_1100_episode_node7_msg_number.mat'
node_data2 = load(filepath2)
